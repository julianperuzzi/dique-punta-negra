...
function PresentationScreen() {
  return (
    ...
    >
      <section className='bg-black bg-opacity-40 dark:bg-opacity-80 backdrop-blur-sm h-screen flex items-center justify-center'>
      <div className="text-left md:text-center text-white p-10">
        <h1 className="text-5xl md:text-7xl font-bold mb-4 md:pb-6 " data-aos="fade-up">Bienvenidos al Dique<span className='text-orange-500'> Punta Negra</span></h1>
