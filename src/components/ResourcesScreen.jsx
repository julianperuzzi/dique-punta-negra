      ...
      <div className="container mx-auto" data-aos="fade-up">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="md:w-2/3 text-left">
            ...
            <h3 className="text-3xl font-semibold mb-4 bg-rose-500 px-3 py-2 text-white ">
            ...
            <h3 className="text-3xl font-semibold mt-8 mb-4 bg-rose-500 px-3 py-2 text-white">
            ...
            <h3 className="text-3xl font-semibold mt-8 bg-rose-500 px-3 py-2 text-white">
